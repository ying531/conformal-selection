...
This repository hosts the R and Python packages, `ConfSelect`, that implements the Weighted Conformalized Selection procedure in our paper [Model-free selective inference under covariate shift via weighted conformal p-values](https://arxiv.org/abs/2307.09291). It also hosts reproduction code for numerical experiments in the paper. 
